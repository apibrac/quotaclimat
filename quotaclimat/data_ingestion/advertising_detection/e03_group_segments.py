"""
Groupement de segments audio par répétitions (style Shazam)
============================================================
Reçoit des segments déjà dotés de leurs hashes (calculés par e02),
...
class SegmentGroupingPipeline:
    ...
    def fingerprint_source(
        self, segments: List[Segment], audio_source: str = ""
    ) -> List[Fingerprint]:
        fingerprints = []
